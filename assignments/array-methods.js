...
runners.forEach(function(object, index, arr){
    let RunnerName = object.first_name + " " + object.last_name;
...
// let allCaps = [];
 ...
 let allCaps = runners.map(function(object, index, arr){
...
let largeShirts = runners.filter((object, index, arr)=>{
